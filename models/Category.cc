...
{"CategoryName","std::string","text",0,0,0,1}
};
...
std::vector<Subject> Category::getSubject(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from Subject where CategoryId = $1";
    Result r(nullptr);
    {
...
void Category::getSubject(const DbClientPtr &clientPtr,
...
std::vector<Assignment> Category::getAssignment(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from Assignment where CategoryId = $1";
    Result r(nullptr);
    {
        auto binder = *clientPtr << sql;
        binder << *id_ << Mode::Blocking >>
...
void Category::getAssignment(const DbClientPtr &clientPtr,
